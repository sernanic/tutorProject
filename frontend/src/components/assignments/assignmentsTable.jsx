...
import { NumberRangeColumnFilter,fuzzyTextFilterFn,AssignmentGlobalFilter,DefaultColumnFilter } from "./assigmentFilters";
...
function AssignmentsTable() {
    ...
    const fetchAssignments = async () => {
        var url = "http://0.0.0.0:8000/assignments/"+getSelectedUser["id"]
    ...
    const data = useMemo(() => allAssignments);
    const columns = useMemo(
        () =>
            allAssignments[0]
                ? Object.keys(allAssignments[0])
    ...
    const assignmentTableInstance = useTable({ columns, data, initialState: { pageIndex: 0 }, filterTypes, defaultColumn }, tableHooks,useFilters, useGlobalFilter, useSortBy,usePagination);
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
